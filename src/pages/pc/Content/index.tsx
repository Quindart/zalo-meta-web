...
function ContentPCLandingTemplate() {
  return (
    <Box
        ...
        py={10}
        px={7}
        sx={{ maxWidth: "1100px", margin: "auto", mt: 5, bgcolor: "white", borderRadius: 2 }}
      >
        {/* Bên trái - Nội dung */}
        <Box>
          ...
          <Box display="flex" paddingTop={4}>
            <Box width="50%">
              ...
              <Stack direction="row" spacing={2} mt={3}>
                <Button variant="contained" color="primary" sx={{ fontWeight: "600", fontSize:20, paddingX:3 , border: "none"}}>
                <img
                ...
                <Button variant="outlined" color="primary" startIcon={<LanguageIcon />} sx={{ fontWeight: "600", fontSize:20, paddingX:3 }}>
                  Dùng bản web
                </Button>
              </Stack>
